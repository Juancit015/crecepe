...
El sistema SHALL mostrar descripciones de 2 líneas en overlays de casos y servicios (logro + detalle) en desktop, ninguna barra superior al hover y ningún texto sobre la foto en móvil.
...
- **THEN** no hay texto sobre la foto; la foto se ve limpia y centrada (reversión de la caption a pedido del usuario)
