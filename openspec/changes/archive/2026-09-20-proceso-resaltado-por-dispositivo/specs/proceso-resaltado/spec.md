...
El sistema SHALL encender el punto de cada paso únicamente cuando cruce la franja central durante el scroll en dispositivos sin hover, sin aplicar resaltado por toque.

#### Scenario: Número brilla al pasar en móvil
- **WHEN** el visitante hace scroll y un paso cruza el centro del viewport en móvil
- **THEN** solo ese punto brilla con anillo, y se apaga al salir de la franja
