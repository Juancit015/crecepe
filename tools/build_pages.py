...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="{p}assets/css/styles.min.css?v=3">
...
pages['privacidad.html'] = dict(
    ...
    <section class="page-body">
        <div class="container legal">
            ...
            <h2 class="svc-h2">4. Analítica</h2>
            <p>El sitio puede usar Google Analytics con datos anonimizados para entender el tráfico y mejorar el contenido. Puedes desactivarlo con la configuración de cookies de tu navegador.</p>
